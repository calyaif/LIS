...
<head>
    ...
    <style>
        ...
        /* DESAIN KARTU PERSIS SEPERTI GAMBAR ANDA */
        .id-card { 
            width: 380px; 
            background: white; 
            border-radius: 6px; 
        ...
        @media print {
            ...
            .action-buttons, .print-info { display: none; }
...
<body>
    ...
    <div class="action-buttons">
        <button class="btn btn-danger" onclick="window.print()">🖨️ Cetak / Simpan PDF</button>
        <button class="btn btn-secondary" onclick="window.close()">✖ Tutup</button>
    </div>

    <div class="print-info">
        Kartu Anggota — Dicetak: <?= date('d F Y, H:i') ?> WIB
    </div>
    ...
    <div class="id-card">
        ...
        <div class="card-body">
            ...
            <div class="card-name"><?= $member['nama'] ?? 'TANPA NAMA' ?></div>
